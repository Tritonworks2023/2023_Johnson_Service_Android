...
//    Call<LoginResponse> LoginResponseCall(@Header("Content-Type") String type, @Body LoginRequest loginRequest);
    ...
    @POST("service_userdetails/breakdown_data_submit_test_2")
...
//  2nd Form Services   //
    ...
    @POST("preventive_service_data_management/submit_data_test_2")
    ...
    @POST("breakdown_data_management/service_mr_eng_mrlist_submit_test_2")
    ...
    @POST("preventive_service_data_management/service_mr_eng_mrlist_submit_test_2")
    ...
    @POST("audit_data_management/submit_test_2")
...
//    Call<FormDataStoreResponse> getformdataListResponseCall1(@Header("Content-Type") String type, @Body GetFieldListResponse getFieldListResponse);
    ...
    Call<NewJobListEscalatorSurveyResponse> getEscalatorFetchDataJobId(@Header("Content-Type") String type, @Body JobIdRequest jobIdRequest);

    @GET("additional_forms/escalator_survey/drop_down")
    Call<MachineControllerTypeResponse> getMachineControllerTypeDropDown(@Header("Content-Type") String type);

    @POST("additional_forms/escalator_survey/create")
    Call<SuccessResponse> getCreateEscalatorSurvey(@Header("Content-Type") String type, @Body EscalatorSurveyFormRequest escalatorSurveyFormRequest);

    @POST("additional_forms/escalator_survey/check_data")
    Call<SuccessResponse> getEscalatorCheckDate(@Header("Content-Type") String type, @Body EscalatorCheckDateRequest escalatorCheckDateRequest);

    //    @POST("additional_forms/elevator_survey/fetch_data_job_id")
    @POST("additional_forms/escalator_survey/fetch_data_job_id")
    Call<NewJobListElevatorSurveyResponse> getElevatorFetchDataJobId(@Header("Content-Type") String type, @Body JobIdRequest jobIdRequest);

    @POST("additional_forms/elevator_survey/check_data")
    Call<SuccessResponse> getElevatorCheckDate(@Header("Content-Type") String type, @Body ElevatorCheckDateRequest elevatorCheckDateRequest);

    @POST("additional_forms/elevator_survey/create")
    Call<SuccessResponse> getCreateElevatorSurvey(@Header("Content-Type") String type, @Body ElevatorSurveyFormRequest elevatorSurveyFormRequest);

    @POST("additional_forms/service_visiblity/create")
    Call<SuccessResponse> getCreateOtherServiceVisibility(@Header("Content-Type") String type, @Body ServiceVisibilityRequest serviceVisibilityRequest);

    @POST("additional_forms/escalator_survey/fetch_data_job_id")
    Call<NewJobListServiceVisibilityResponse> getServiceVisibilityFetchDataJobId(@Header("Content-Type") String type, @Body JobIdRequest jobIdRequest);

    @POST("additional_forms/service_visiblity/get_imie_brcd")
    Call<EmployeeDetailsListResponse> getImieBrcd(@Header("Content-Type") String type, @Body ImieBrcdRequest imieBrcdRequest);

    @POST("additional_forms/service_visiblity/check_data")
    Call<SuccessResponse> getServiceVisibilityCheckDate(@Header("Content-Type") String type, @Body ServiceVisibilityCheckDateRequest serviceVisibilityCheckDateRequest);

    @POST("additional_forms/service_visiblity/create")
    Call<SuccessResponse> getCreateSmartServiceVisibility(@Header("Content-Type") String type, @Body ServiceVisibilityRequest serviceVisibilityRequest);

    @Multipart
    @POST("service_visiblity_upload")
    Call<FileUploadResponse> getServiceVisibilityUpload(
            @Part("job_id") RequestBody jobId,
            @Part("cat_type") RequestBody catType,
            @Part("program_date") RequestBody programDate,
    ...
    @POST("additional_forms/escalator_survey/fetch_data_job_id")
    Call<JobListFailureReportResponse> getFailureReportFetchDataJobId(@Header("Content-Type") String type, @Body JobIdRequest jobIdRequest);

    @POST("additional_forms/failure_report/check_data")
    Call<SuccessResponse> getFailureReportCheckDate(@Header("Content-Type") String type, @Body FailureReportCheckDataRequest failureReportCheckDataRequest);

    @POST("additional_forms/escalator_survey/fetch_data_job_id")
    Call<JobListRopeMaintenanceResponse> getRopeMaintenanceFetchDataJobId(@Header("Content-Type") String type, @Body JobIdRequest jobIdRequest);

    @POST("additional_forms/rope_maintenance/check_data")
    Call<SuccessResponse> getRopeMaintenanceCheckDate(@Header("Content-Type") String type, @Body RopeMaintenanceCheckDataRequest ropeMaintenanceCheckDataRequest);
