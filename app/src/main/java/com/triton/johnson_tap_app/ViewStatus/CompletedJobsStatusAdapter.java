...
public class CompletedJobsStatusAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    ViewStatusResponse.Data.CompletedData currentItem;
    List<ViewStatusResponse.Data.CompletedData> breedTypedataBeanList;
    ...
    public CompletedJobsStatusAdapter(Job_StatusActivity job_statusActivity, List<ViewStatusResponse.Data.CompletedData> completedDataList) {

        this.context = job_statusActivity;
        this.breedTypedataBeanList = completedDataList;
