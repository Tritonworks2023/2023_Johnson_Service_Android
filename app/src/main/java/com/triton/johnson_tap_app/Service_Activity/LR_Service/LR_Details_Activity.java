...
public class LR_Details_Activity extends AppCompatActivity {
    ...
    TextView txt_LrNo, txt_LrData, txt_QuoteNo, txt_Customername, txt_Adone, txt_Adtwo, txt_Adthree, txt_Adfour,
            txt_Pin, txt_Mobileno, txt_Servicetype, txt_Mechname;
    String TAG = LR_Details_Activity.class.getSimpleName(), str_Lrno, str_LrData, str_QuoteNo, str_Customername,
            str_Adone, str_Adtwo, str_Adthree, str_Adfour, str_Pin, str_MobileNo, str_Servicetype, str_Mechname;
    Context context;
    String status, job_id, se_user_mobile_no, se_user_name, se_id, check_id, service_title, message, compno,
            sertype, str_Techsign, str_CustAck;
...
//                Toast.makeText(context, "Kindly enable the GPS Location and Try again", Toast.LENGTH_SHORT).show();
    ...
    private CheckOutstandingJobRequest checkOustandingjob() {
        ...
        checkOutstandingJobRequest.setJob_id(job_id);
