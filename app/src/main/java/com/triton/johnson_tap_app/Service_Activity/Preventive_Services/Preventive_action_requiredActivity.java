...
public class Preventive_action_requiredActivity extends AppCompatActivity {
    ...
    String form1_value, TAG = Preventive_action_requiredActivity.class.getSimpleName();
    String form1_name;
...
//            Log.e("My Checklist","" + preventive_check);
        ...
        Log.i(TAG, "onCreate: Job Date -> " + List);
...
//                startActivity(send);
    ...
    private void Job_status_update() {
        ...
        Log.i(TAG, "Job_status_update: " + call.request().url().toString());
