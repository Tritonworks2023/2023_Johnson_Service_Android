...
public class NewJobListElevatorSurveyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    String TAG = NewJobListElevatorSurveyAdapter.class.getSimpleName(), formattedDate = "";
    List<NewJobListElevatorSurveyResponse.Data> newJobListElevatorSurveyDataResponseList;
    NewJobListElevatorSurveyResponse.Data currentItem;
    OnItemClickDataChangeListener onItemClickDataChangeListener;

    public NewJobListElevatorSurveyAdapter(List<NewJobListElevatorSurveyResponse.Data> newJobListElevatorSurveyDataResponseList, OnItemClickDataChangeListener onItemClickDataChangeListener) {

        this.newJobListElevatorSurveyDataResponseList = newJobListElevatorSurveyDataResponseList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_new_job_elevator_survey, parent, false);
    ...
    private void initLayoutOne(ViewHolderOne holder, int position) {
        ...
        currentItem = newJobListElevatorSurveyDataResponseList.get(position);
    ...
    public int getItemCount() {
        return newJobListElevatorSurveyDataResponseList.size();
    }

    public void filteredList(List<NewJobListElevatorSurveyResponse.Data> filteredlist) {
        newJobListElevatorSurveyDataResponseList = filteredlist;
        notifyDataSetChanged();
    }

    private void setDate(NewJobListElevatorSurveyAdapter.ViewHolderOne holder, String inputDateTime) {
