...
public class CustomerDetailsBreakdownMR_Activity extends AppCompatActivity {
    ...
    String compno, sertype, status, TAG = CustomerDetailsBreakdownMR_Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_details_breakdown_mr);
        context = this;
        ...
        //job_status = sharedPreferences.getString("jobstatus", "new");
        ...
        if (status.equals("pause")) {
            ...
            iv_back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent send = new Intent(CustomerDetailsBreakdownMR_Activity.this, PausedServicesBreakdownMR_Activity.class);
            ...
            iv_back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent send = new Intent(CustomerDetailsBreakdownMR_Activity.this, JobDetails_BreakdownMRActivity.class);
                    send.putExtra("service_title", service_title);
                    send.putExtra("status", status);
                    startActivity(send);
...
//                Intent send = new Intent(CustomerDetailsBreakdownMR_Activity.this, StartJob_BreakdownMR_Activity.class);
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void getMYLocation() {
        ...
        if (gpsTracker.canGetLocation()) {
            ...
            Log.i(TAG, "getMYLocation: Lat: " + latitude + " Long: " + longitude);
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void Custom_details() {
        ...
        APIInterface apiInterface = RetrofitClient.getClient().create(APIInterface.class);
        Call<Custom_detailsResponse> call = apiInterface.Customer_detailsResponseCall(RestUtils.getContentType(), custom_detailsRequest());
