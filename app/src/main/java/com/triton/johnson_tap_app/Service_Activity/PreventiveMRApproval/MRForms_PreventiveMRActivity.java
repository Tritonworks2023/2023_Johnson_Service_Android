...
public class MRForms_PreventiveMRActivity extends AppCompatActivity {
    ...
    private String TAG = MRForms_PreventiveMRActivity.class.getSimpleName();
...
//        dialog = new ProgressDialog(context, R.style.NewProgressDialog);
...
//        }, delayInMillis);
        ...
        call.enqueue(new Callback<ServiceUserdetailsResponse>() {
            ...
            @Override
            public void onResponse(@NonNull Call<ServiceUserdetailsResponse> call, @NonNull Response<ServiceUserdetailsResponse> response) {

                Log.i(TAG, "Callservice_userdetails: onResponse: ServiceUserdetailsResponse -> " + new Gson().toJson(response.body()));
                    ...
                    if (200 == response.body().getCode()) {
                        if (response.body().getData() != null) {
                            ...
                            for (i = 0; i < servicedetailsbean.size(); i++) {
                                ...
                                Log.i(TAG, "onResponse: MR param -> " + title + " value -> " + value);
                            }
                        } else {
                            //ErrorAlert();
                        }
            ...
            @Override
            public void onFailure(@NonNull Call<ServiceUserdetailsResponse> call, @NonNull Throwable t) {
