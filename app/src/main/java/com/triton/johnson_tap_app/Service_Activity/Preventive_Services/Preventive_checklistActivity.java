...
public class Preventive_checklistActivity extends AppCompatActivity implements UserTypeSelectListener1 {
    ...
    String form1_value, TAG = Preventive_checklistActivity.class.getSimpleName();
    String form1_name;
...
//            Log.e("Job ID", ""+ job_id);
            Log.i(TAG, "onCreate: job_id - "+job_id);
        }
        ...
        Log.i(TAG, "onCreate: value_s - " + value_s + " statustype - " + statustype +
                " List - " + List + " service_title - " + service_title + " jobid - " + jobid);
...
//        super.onBackPressed();
        ...
        if (value_s != null && value_s.equals("yes")) {
            Intent send = new Intent(Preventive_checklistActivity.this, Material_Request_MR_Screen_PreventiveActivity.class);
            send.putExtra("status", status);
            startActivity(send);
        } else {
