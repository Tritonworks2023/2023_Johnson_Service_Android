...
public class Customer_Details_preActivity extends AppCompatActivity {

    ImageView iv_back;
    Button btn_continue, btn_Skip;
    Dialog dialog;
    Dialog alertdialog;
    String TAG = Customer_Details_preActivity.class.getSimpleName(), se_user_mobile_no, se_user_name,
            se_id, check_id, service_title, str_job_id, message, str_address1, str_address2, str_address3,
            str_pin, str_contract_type, str_contract_status, str_jobid, str_custom_name, str_bd_no,
            str_bd_date, str_breakdaown_type;
    TextView address1, address2, address3, pin, contract_type, contract_status, job_id, customer_name,
            bd_number, bd_date, breakdown_type;
    String compno, sertype, status, str_Remarks, networkStatus = "";
    AlertDialog alertDialog;
    Context context;
    SharedPreferences sharedPreferences;
    CheckOutstandingJobResponse.Data databean;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_details_pre);
        context = this;
...
//                Intent send = new Intent(Customer_Details_preActivity.this, Job_Details_PreventiveActivity.class);
...
//                Intent send = new Intent(Customer_Details_preActivity.this, Start_Job_Text_PreventiveActivity.class);
    ...
    private void skipJobDetailsCall() {
        ...
        call.enqueue(new Callback<SuccessResponse>() {
            ...
            public void onResponse(Call<SuccessResponse> call, Response<SuccessResponse> response) {
                ...
                Log.w(TAG, "Skip Job Details Response" + new Gson().toJson(response.body()));
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private SkipJobDetailRequest skipJobRequest() {
        ...
        skipJobDetailRequest.setJob_id(str_job_id);
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void Custom_details() {
        ...
        APIInterface apiInterface = RetrofitClient.getClient().create(APIInterface.class);
        Call<Custom_detailsResponse> call = apiInterface.Custom_details_PreventiveResponseCall(RestUtils.getContentType(), custom_detailsRequest());
