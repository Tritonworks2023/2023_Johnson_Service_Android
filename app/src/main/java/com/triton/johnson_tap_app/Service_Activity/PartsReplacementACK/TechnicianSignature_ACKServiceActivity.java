...
public class TechnicianSignature_ACKServiceActivity extends AppCompatActivity {
    ...
    Context context;
    String TAG = TechnicianSignature_ACKServiceActivity.class.getSimpleName(), status, job_id, se_user_mobile_no,
            se_user_name, se_id, check_id, service_title, message, compno, sertype, str_Techsign, str_CustAck;
