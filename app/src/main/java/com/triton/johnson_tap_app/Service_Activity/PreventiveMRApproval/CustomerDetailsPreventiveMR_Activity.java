...
public class CustomerDetailsPreventiveMR_Activity extends AppCompatActivity {
    ...
    Dialog dialog;
    Dialog alertdialog;
    String TAG = CustomerDetailsPreventiveMR_Activity.class.getSimpleName(), se_user_mobile_no, se_user_name, se_id, check_id, service_title, str_job_id, message, str_address1, str_address2, str_address3, str_pin, str_contract_type, str_contract_status, str_jobid, str_custom_name, str_bd_no, str_bd_date, str_breakdaown_type;
