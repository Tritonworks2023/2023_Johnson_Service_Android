...
public class CustomerAcknowledgement_LRServiceActivity extends AppCompatActivity {
    ...
    Context context;
    String TAG = CustomerAcknowledgement_LRServiceActivity.class.getSimpleName(), status, job_id,
            str_Custname, str_Custno, str_Custremarks, se_user_mobile_no, se_user_name, se_id, service_title;
    Dialog dialog;
    SharedPreferences sharedPreferences;
    ProgressDialog progressDialog;
    Bitmap signatureBitmap;
    MultipartBody.Part siganaturePart;
    String userid, uploadimagepath = "", str_Techsign, str_CustAck, str_job_status, message, service_type,
            str_Quoteno, networkStatus = "";
