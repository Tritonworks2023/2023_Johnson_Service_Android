...
public class Technician_signature_preventiveActivity extends AppCompatActivity {
    ...
    String address = "", TAG = Technician_signature_preventiveActivity.class.getSimpleName();
    int PageNumber = 8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("JobID", "" + job_id);
        Log.i(TAG, "onCreate: share job_id - " + job_id);
        ...
        Log.i(TAG, "onCreate: statustype -> " + statustype);
        ...
        if (extras != null) {
            ...
            Log.i(TAG, "onCreate: extra job_id - " + job_id);
        }
                ...
                if (response.body() != null) {
                    ...
                    if (response.body().getCode() == 200) {
                        ...
                        if (response.body().getData() != null) {
                            ...
                            Log.i(TAG, "onResponse: uploadimagepath - " + uploadimagepath);
    ...
    private void getSign(String job_id, String myactivity) {
        ...
        if (cur.getCount() > 0 && cur.moveToFirst()) {
            ...
            do {
                ...
                Log.i(TAG, "getSign: uploadimagepath - " + uploadimagepath);
