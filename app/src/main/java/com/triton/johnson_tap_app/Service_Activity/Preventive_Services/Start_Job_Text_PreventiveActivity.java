...
public class Start_Job_Text_PreventiveActivity extends AppCompatActivity {
    ...
    Geocoder geocoder;
    double Latitude = 0.0, Logitude = 0.0;
    String address = "", networkStatus = "", TAG = Start_Job_Text_PreventiveActivity.class.getSimpleName();
...
//                    getSampleLoc();
                    ...
                    if (networkStatus.equalsIgnoreCase("Not connected to Internet")) {
                        ...
                        Log.i(TAG, "send: onClick: Lat -> " + Latitude + " Long -> " + Logitude + " Add -> " + address);
                    }
        ...
        ll_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkStatus.equalsIgnoreCase("Not connected to Internet")) {
                    ...
                    Log.i(TAG, "ll_start: onClick: Lat -> " + Latitude + " Long -> " + Logitude + " Add -> " + address);
                }
...
//                            Log.e("PAGE NUMBER", String.valueOf(PageNumber));
                            Log.i(TAG, "retriveLocalvalue: onResponse: str_job_status -> " + str_job_status);
                            ...
                            if (PageNumber == 0) {
                            ...
                            } else if (str_job_status != null && !str_job_status.isEmpty() && str_job_status.equals("ESC/TRV") && PageNumber == 1) {
                                ...
                                SharedPreferences.Editor editor1 = sharedPreferences.edit();
                                editor1.putString("statustype", "ESC/TRV");
                                editor1.putString("starttime", str_StartTime);
                                editor1.putString("lati", String.valueOf(Latitude));
                                editor1.putString("long", String.valueOf(Logitude));
                                editor1.putString("add", address);
                                ...
                                SubPageNumber = response.body().getData().getSubPage_number();
                                Log.i(TAG, "retriveLocalvalue: onResponse: SubPageNumber - " + SubPageNumber);
...
//                                Toast.makeText(context,"Page Not Found",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Call<RetriveResponsePR> call, @NonNull Throwable t) {
                Log.e(TAG, "retriveLocalvalue: onFailure: error - " + t.getMessage());
    ...
    private Job_status_updateRequest localRequest() {
        ...
        Log.i(TAG, "localRequest: createlocaldata - " + new Gson().toJson(createlocaldata));
...
//                            }
    ...
    private void Check_Pod_Status() {
        ...
        Log.i(TAG, "Check_Pod_Status: URL: " + call.request().url().toString());
        call.enqueue(new Callback<Check_Pod_StatusResponse>() {
            ...
            public void onResponse(@NonNull Call<Check_Pod_StatusResponse> call, @NonNull retrofit2.Response<Check_Pod_StatusResponse> response) {
                Log.i(TAG, "Check_Pod_Status: onResponse: Check_Pod_StatusResponse -> " + new Gson().toJson(response.body()));
...
//                            startActivity(send3);
            ...
            public void onFailure(@NonNull Call<Check_Pod_StatusResponse> call, @NonNull Throwable t) {
                ...
                Log.e(TAG, "Check_Pod_Status: onFailure: error -> " + t.getMessage());
                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (gpsTracker.canGetLocation()) {
            ...
            if (Latitude != 0.0 && Logitude != 0.0) {
                ...
                try {
                    ...
                    editor.apply();
                    Log.i(TAG, "getMYLocation: Latitude -> " + Latitude + " Logitude -> " + Logitude + " address -> " + address);
