...
public class SchSafServiceVisibilityFormActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String TAG = SchSafServiceVisibilityFormActivity.class.getSimpleName(), se_id, se_user_name, se_user_mobile_no,
            se_user_location, strSelectedCatCode, strSelectedCatName, userid = "", strDateType = "", uploadImagePath = "";
    private TextView txt_cat, txt_emp_id, txt_emp_name, txt_program_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sch_saf_service_visibility_form);
    ...
    private void choosePetImage() {
        if (pet_imgList != null && pet_imgList.size() >= 4) {
            ...
            if (!hasPermissions(this, PERMISSIONS)) {
                ...
                CropImage.activity().start(SchSafServiceVisibilityFormActivity.this);
            }
        }
    }
    ...
    private void setValidationCreateSmartServiceVisibility() {
        ...
        serviceVisibilityRequest.setCus_name(CommonFunction.nullPointer(edt_cust_name.getText().toString().trim()));
        if (!checkDate) {
            ErrorMsgDialog("Already you have submitted for this Date.\nKindly select another Date.");
