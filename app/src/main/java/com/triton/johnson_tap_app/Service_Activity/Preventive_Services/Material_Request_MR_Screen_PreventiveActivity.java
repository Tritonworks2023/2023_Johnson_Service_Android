...
public class Material_Request_MR_Screen_PreventiveActivity extends AppCompatActivity {
    ...
    String TAG = Material_Request_MR_Screen_PreventiveActivity.class.getSimpleName(), value_s, List = "", compno, sertype, se_id, se_user_mobile_no, se_user_name, statustype = "", message, str_job_status;
