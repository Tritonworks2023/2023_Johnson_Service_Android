...
public class StartJob_ACK_Activity<location> extends AppCompatActivity {
    ...
    TextView text;
    ImageView iv_back;
    String TAG = StartJob_ACK_Activity.class.getSimpleName(), se_user_mobile_no, se_user_name, se_id, check_id,
            service_title, job_id, message, str_job_status;
...
//                startActivity(send);
        ...
        if (status.equals("pause")) {
            ...
            add_fab.setImageResource(R.drawable.ic_resume);
