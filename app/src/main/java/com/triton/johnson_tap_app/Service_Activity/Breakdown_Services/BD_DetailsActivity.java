...
public class BD_DetailsActivity extends AppCompatActivity implements UserTypeSelectListener1, OnItemClickCheckBoxBreakDownDetails {
    ...
    String address = "", TAG = BD_DetailsActivity.class.getSimpleName();
    Geocoder geocoder;
...
//                            setView(breedTypedataBeanList);
    ...
    private void jobFindResponseCall(String job_no) {
        ...
        Log.i(TAG, "Jobno Find Response url  :%s" + " " + call.request().url().toString());
        call.enqueue(new Callback<BD_DetailsResponse>() {
            ...
            public void onResponse(@NonNull Call<BD_DetailsResponse> call, @NonNull Response<BD_DetailsResponse> response) {
                Log.i(TAG, "Jobno Find Response -> " + new Gson().toJson(response.body()));
    ...
    private void createLocalvalue() {
        ...
        call.enqueue(new Callback<SuccessResponse>() {
            ...
            public void onFailure(@NonNull Call<SuccessResponse> call, @NonNull Throwable t) {
                ErrorMsgDialog(t.getMessage());
                Log.e(TAG, "createLocalvalue: onFailure: " + t.getMessage());
                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//        getBDDetails();
        ...
        Log.i(TAG, "createLocalRequest: Pause Page Number -> " + PageNumber);
