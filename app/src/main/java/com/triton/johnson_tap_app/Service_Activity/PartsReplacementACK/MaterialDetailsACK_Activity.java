...
public class MaterialDetailsACK_Activity extends AppCompatActivity {
    ...
    Context context;
    String TAG = MaterialDetailsACK_Activity.class.getSimpleName(), status, job_id, se_user_mobile_no,
            se_user_name, se_id, check_id, service_title, message, compno, sertype, str_Techsign,
            str_CustAck, str_ACKCompno;
    ...
    private void materialDetailscall() {
        ...
        call.enqueue(new Callback<Material_DetailsResponseACK>() {
            ...
            public void onResponse(Call<Material_DetailsResponseACK> call, Response<Material_DetailsResponseACK> response) {
                ...
                Log.e(TAG, "Material Response  " + new Gson().toJson(response.body()));
