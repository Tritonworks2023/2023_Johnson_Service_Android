...
public class Customer_Details_PreventiveActivity extends AppCompatActivity {
    ...
    String[] strGroupid;
    String[] strCatid;
    String TAG = Customer_Details_PreventiveActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            Log.i(TAG, "onCreate: customer_name - " + customer_name);
        }
        if (extras != null) {
            customer_no = extras.getString("customer_no");
            et_cust_no.setText(customer_no);
            Log.i(TAG, "onCreate: customer_no - " + customer_no);
        }
