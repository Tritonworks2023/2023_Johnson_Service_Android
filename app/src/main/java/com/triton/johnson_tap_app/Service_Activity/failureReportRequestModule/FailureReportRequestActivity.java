...
public class FailureReportRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_failure_report_request);

        context = this;

        iv_back = findViewById(R.id.iv_back);
        cv_new_job = findViewById(R.id.cv_new_job);
        cv_pasused_job = findViewById(R.id.cv_pasused_job);
