...
public class ESCTRV extends AppCompatActivity implements JobDateListener {
    ...
    Button btn_Next;
    String str_job_id, service_title, value = "", se_id, se_user_mobile_no, compno, sertype, pre_check = "",
            status = "", message, str_job_status;
    Context context;
    ...
    String statustype, TAG = ESCTRV.class.getSimpleName();
...
//        CommonUtil.dbUtil.getPreventiveListDelete();
        ...
        Log.i(TAG, "onCreate: Value -> " + statustype);
...
//                intent.putExtra("BUNDLE",args);
                    ...
                    Log.i(TAG, "onClick: status - " + status);
                        ...
                        public void onActivityResult(ActivityResult result) {
                            if(result.getResultCode()==Activity.RESULT_OK){
                                ...
                                if (data != null) {
                                    ...
                                    Log.i(TAG, "onClick: status1 -> " + status);
                                    status = data.getStringExtra("status");
                                    Log.i(TAG, "onClick: status2 -> " + status);
                                }
                            }
                        }
                        });*/
...
//                startActivity(intent);
    ...
    private Preventive_Submit_Request createLocalRequest() {
        ...
        Log.i(TAG, "createLocalRequest: localRequest --> " + new Gson().toJson(localRequest));
        return localRequest;
    }
    ...
    private void getPreventivecheck() {
        ...
        Log.i(TAG, "getPreventivecheck: Month List -> " + pre_check);
