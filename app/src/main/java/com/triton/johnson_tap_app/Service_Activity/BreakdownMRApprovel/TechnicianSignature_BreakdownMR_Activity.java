...
public class TechnicianSignature_BreakdownMR_Activity extends AppCompatActivity {
    ...
    Dialog dialog;
    String compno, sertype, TAG = TechnicianSignature_BreakdownMR_Activity.class.getSimpleName();
    String signfile;
    Context context;
...
//                Bitmap bitmap = BitmapFactory.decodeFile(filePath);
    ...
    private void serviceUserDetailsRequestResponse() {
        ...
        ServiceUserdetailsRequestResponse serviceUserdetailsRequestResponse = submitRequest();

        if (serviceUserdetailsRequestResponse != null) {

            APIInterface apiInterface = RetrofitClient.getClient().create(APIInterface.class);
            Call<SuccessResponse> call = apiInterface.ServiceUserdetailsRequestsubmitMRListCall(RestUtils.getContentType(), serviceUserdetailsRequestResponse);
...
//                          showErrorLoading(response.body().getMessage());
                ...
                public void onFailure(@NonNull Call<SuccessResponse> call, @NonNull Throwable t) {
                    Log.e(TAG, "serviceUserDetailsRequestResponse: onFailure: " + t.getMessage());
                ...
                if (uploadimagepath != null && !uploadimagepath.isEmpty()) {
                    ...
                    if (compno != null && !compno.isEmpty()) {
                        ...
                        if (sertype != null && !sertype.isEmpty()) {
                            ...
                            Log.i(TAG, "submitRequest: ServiceUserdetailsRequestResponse -> " + new Gson().toJson(submitRequest));
                            return submitRequest;
                        } else {
