...
public class BreakdownMRListOne_Activity extends AppCompatActivity implements QuantityListener {
...
//                }
    ...
    public void getMRList() {
        ...
        BreakdownMRListOne_Adapter adapter = new BreakdownMRListOne_Adapter(arli_Partid, arli_Partname, arli_Partno, arli_Quantity, context, this);
...
//                                    }
                            ...
                            if (CommonUtil.dbUtil.hasMRList(strPartno, strPartname, "1", job_id, service_title)) {
                                Log.e("Hi Nish", "Had Data");
                                CommonUtil.dbUtil.deleteMRList(strPartno, strPartname, "1", job_id, service_title);
                                Cursor cur = CommonUtil.dbUtil.getMRList(job_id, "1", service_title);
                                Log.e("List Count", "" + cur.getCount());
                                CommonUtil.dbUtil.addMRList(strPartno, strPartname, "1", job_id, service_title, strQuantity);
