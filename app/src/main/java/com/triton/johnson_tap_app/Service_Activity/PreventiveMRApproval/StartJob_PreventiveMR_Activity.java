...
public class StartJob_PreventiveMR_Activity extends AppCompatActivity {
    ...
    TextView text;
    ImageView iv_back;
    String TAG = StartJob_PreventiveMR_Activity.class.getSimpleName(), se_user_mobile_no, se_user_name, se_id,
            check_id, service_title, str_job_id, message, str_job_status;
