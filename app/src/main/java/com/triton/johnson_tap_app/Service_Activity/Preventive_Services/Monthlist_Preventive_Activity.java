...
public class Monthlist_Preventive_Activity extends AppCompatActivity implements JobDateListener {
    ...
    String TAG = Monthlist_Preventive_Activity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.i(TAG, "onCreate: Name -> " + service_title + " JobID -> " + str_job_id + " Value -> " + statustype);
...
//        Log.e("Checklist Delete",""+curs.getCount());
        ...
        if (extras != null) {
            ...
            Log.i(TAG, "onCreate: status -> " + status + " value -> " + value);
        }
...
//                startActivity(intent);
    ...
    private void retriveLocalvalue() {
        ...
        Log.i(TAG, "retriveLocalvalue: retriveLocalValuePRCall URL - " + call.request().url().toString());
...
//                Log.e("Retrive Response","" + new Gson().toJson(response.body()));
    ...
    private void getPreventivecheck() {
        ...
        Log.i(TAG, "getPreventivecheck: pre_check -> " + pre_check);
        Log.i(TAG, "getPreventivecheck: mydata -> " + mydata);
        Log.i(TAG, "getPreventivecheck: str mydata -> " + String.valueOf(mydata));
        ...
        Log.i(TAG, "getPreventivecheck: share List -> " + sharedPreferences.getString("List", "1"));
...
//        localRequest.setJob_status_type(e"ESC/TRV");
...
//        localRequest.setSubPage_number(Integer.parseInt(SubPageNumber));
        ...
        Log.i(TAG, "createLocalRequest: statustype -> " + statustype);
