...
public class PreventiveMRListOne_Activity extends AppCompatActivity implements QuantityListener {
    ...
    private String TAG = PreventiveMRListOne_Activity.class.getSimpleName();
...
//                Log.e("MR Count",""+ cursor.getCount());
                ...
                if (status.equals("pause")) {
                    Log.i(TAG, "onCreate: submitButton onClick: -> " + status);
                    createLocalData();
                }
//
//                Cursor cur = CommonUtil.dbUtil.getMRList(job_id,"2",service_title);
...
//        local.setMrData(mrData);
    ...
    private void retrive_LocalValue() {
        ...
        call.enqueue(new Callback<Retrive_LocalValueResponse>() {
            @Override
            public void onResponse(@NonNull Call<Retrive_LocalValueResponse> call, @NonNull Response<Retrive_LocalValueResponse> response) {
                Log.i(TAG, "retrive_LocalValue: onResponse: Retrive_LocalValueResponse -> " + new Gson().toJson(response.body()));
            ...
            @Override
            public void onFailure(@NonNull Call<Retrive_LocalValueResponse> call, @NonNull Throwable t) {
    ...
    private void createLocalData() {
        ...
        Log.i(TAG, "createLocalData: URL -> " + call.request().url().toString());
        call.enqueue(new Callback<SuccessResponse>() {
            @Override
            public void onResponse(@NonNull Call<SuccessResponse> call, @NonNull Response<SuccessResponse> response) {
                Log.i(TAG, "createLocalData: onResponse: SuccessResponse -> " + new Gson().toJson(response.body()));
...
//                            startActivity(send);
            ...
            public void onFailure(@NonNull Call<SuccessResponse> call, @NonNull Throwable t) {
                ...
                Log.e(TAG, "createLocalData: onFailure: " + t.getMessage());
