...
public class RepairWorkRequestApprovalRequestListRpMechResponse implements Parcelable {
    public static final Creator<RepairWorkRequestApprovalRequestListRpMechResponse> CREATOR = new Creator<RepairWorkRequestApprovalRequestListRpMechResponse>() {
        @Override
        public RepairWorkRequestApprovalRequestListRpMechResponse createFromParcel(Parcel in) {
            return new RepairWorkRequestApprovalRequestListRpMechResponse(in);
        }

        @Override
        public RepairWorkRequestApprovalRequestListRpMechResponse[] newArray(int size) {
            return new RepairWorkRequestApprovalRequestListRpMechResponse[size];
        }
    };
    @Expose
    @SerializedName("Code")
    ...
    protected RepairWorkRequestApprovalRequestListRpMechResponse(Parcel in) {
        Code = in.readInt();
        Data = in.readParcelable(RepairWorkRequestApprovalRequestListRpMechResponse.Data.class.getClassLoader());
