...
public class JobListRopeMaintenanceResponse implements Parcelable {
    public static final Creator<JobListRopeMaintenanceResponse> CREATOR = new Creator<JobListRopeMaintenanceResponse>() {
        @Override
        public JobListRopeMaintenanceResponse createFromParcel(Parcel in) {
            return new JobListRopeMaintenanceResponse(in);
        }

        @Override
        public JobListRopeMaintenanceResponse[] newArray(int size) {
            return new JobListRopeMaintenanceResponse[size];
        }
    };
    @Expose
    @SerializedName("Code")
    ...
    @Expose
    @SerializedName("Data")
    private ArrayList<JobListRopeMaintenanceResponse.Data> Data;
    @Expose
    ...
    public JobListRopeMaintenanceResponse() {
    }

    protected JobListRopeMaintenanceResponse(Parcel in) {
        Code = in.readInt();
        Data = in.readParcelable(JobListRopeMaintenanceResponse.Data.class.getClassLoader());
    ...
    public ArrayList<JobListRopeMaintenanceResponse.Data> getData() {
        return Data;
    }

    public void setData(ArrayList<JobListRopeMaintenanceResponse.Data> Data) {
        this.Data = Data;
    }
    ...
    public static class Data implements Parcelable {
        ...
        public static final Creator<JobListRopeMaintenanceResponse.Data> CREATOR = new Creator<JobListRopeMaintenanceResponse.Data>() {
            @Override
            public JobListRopeMaintenanceResponse.Data createFromParcel(Parcel in) {
                return new JobListRopeMaintenanceResponse.Data(in);
            }

            @Override
            public JobListRopeMaintenanceResponse.Data[] newArray(int size) {
                return new JobListRopeMaintenanceResponse.Data[size];
            }
        };
