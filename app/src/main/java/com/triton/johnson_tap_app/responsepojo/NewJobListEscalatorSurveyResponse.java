...
public class NewJobListEscalatorSurveyResponse implements Parcelable {
    public static final Creator<NewJobListEscalatorSurveyResponse> CREATOR = new Creator<NewJobListEscalatorSurveyResponse>() {
        @Override
        public NewJobListEscalatorSurveyResponse createFromParcel(Parcel in) {
            return new NewJobListEscalatorSurveyResponse(in);
        }

        @Override
        public NewJobListEscalatorSurveyResponse[] newArray(int size) {
            return new NewJobListEscalatorSurveyResponse[size];
        }
    };
    @Expose
    @SerializedName("Code")
    ...
    public NewJobListEscalatorSurveyResponse() {
    }

    protected NewJobListEscalatorSurveyResponse(Parcel in) {
        Code = in.readInt();
