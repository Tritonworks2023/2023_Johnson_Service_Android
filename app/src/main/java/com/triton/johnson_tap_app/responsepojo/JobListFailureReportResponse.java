...
public class JobListFailureReportResponse implements Parcelable {
    public static final Creator<JobListFailureReportResponse> CREATOR = new Creator<JobListFailureReportResponse>() {
        @Override
        public JobListFailureReportResponse createFromParcel(Parcel in) {
            return new JobListFailureReportResponse(in);
        }

        @Override
        public JobListFailureReportResponse[] newArray(int size) {
            return new JobListFailureReportResponse[size];
        }
    };
    @Expose
    @SerializedName("Code")
