...
public class JobListResponse {
    ...
    public JobListResponse(String status, String message, List<DataBean> data, int code) {
        Status = status;
        Message = message;
        Data = data;
        Code = code;
    ...
    public static class DataBean {
        ...
        public DataBean(String job_id, String customer_name, String pm_date, String status, String SMU_SCH_COMPNO, String SMU_SCH_SERTYPE, String SMU_SCQH_QUOTENO, String SMU_ACK_COMPNO, String OM_OSA_COMPNO, String name, String date) {
            this.job_id = job_id;
