...
public class EscalatorCheckDateRequest {
    @Expose
    ...
    public EscalatorCheckDateRequest() {
    }

    public EscalatorCheckDateRequest(String submitted_by_num, String survey_no, String job_id) {
