...
public class Notification_Activity extends AppCompatActivity {
    ...
    String TAG = Notification_Activity.class.getSimpleName(), se_user_mobile_no, message;
    ...
    private void notificationDelete() {
        ...
        call.enqueue(new Callback<SuccessResponse>() {
            ...
            public void onResponse(@NonNull Call<SuccessResponse> call, @NonNull Response<SuccessResponse> response) {
                ...
                Log.w(TAG, " Notification Delete Response" + new Gson().toJson(response.body()));
            }
    ...
    private void notificationUpdate() {
        ...
        call.enqueue(new Callback<SuccessResponse>() {
            ...
            public void onResponse(@NonNull Call<SuccessResponse> call, @NonNull Response<SuccessResponse> response) {
                ...
                Log.w(TAG, " Notification Update Response" + new Gson().toJson(response.body()));
            }
    ...
    private void notificationCall() {
        ...
        call.enqueue(new Callback<NotificationListResponse>() {
            ...
            public void onResponse(@NonNull Call<NotificationListResponse> call, @NonNull Response<NotificationListResponse> response) {
                ...
                Log.w(TAG, " Notification List Response" + new Gson().toJson(response.body()));
