...
public class Dashbaord_MainActivity extends AppCompatActivity {
    ...
    private String TAG = Dashbaord_MainActivity.class.getSimpleName();
...
//            Toast.makeText(this, "android_id: " + android_id, Toast.LENGTH_LONG).show();
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    Log.i(TAG, "onCreate: telephonyManager -> " + telephonyManager.getImei());
                }
            } else {
    ...
    private void getPopupImage() {
        ...
        Log.i(TAG, "Get PopUp Image url -> " + call.request().url().toString());
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private GetPopUpImageRequest getpopupImageRequest() {
        ...
        Log.i(TAG, "Get PopUp Image Request -> " + new Gson().toJson(getPopUpImageRequest));
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void logoutCall() {
        ...
        Log.w(TAG, "Logout Response url  :%s" + " " + call.request().url().toString());
